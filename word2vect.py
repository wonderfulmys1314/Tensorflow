...
# 绘图设置
mpl.rcParams['font.sans-serif'] = ['SimHei']   # 用于显示中文标签
mpl.rcParams['font.family'] = 'STSong'
mpl.rcParams['font.size'] = 20

training_file = "data/文本.txt"
...
training_label, count, dictionary, words = build_dataset(training_ci, 400)
...
def generate_batch(data, batch_size, num_skips, skip_window):
    """
    :param data: 输入数据
    :param batch_size: 训练尺寸
    :param num_skips: 输出标签数量
    :param skip_window: 前后取词数量
    :return:
    """
    global data_index
